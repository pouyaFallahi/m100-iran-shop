...
urlpatterns = [
            ...
            path('change-password/send/', views_user.email_send, name='email_send'),
            path('change-password/', views_user.change_password, name='change'),
            path('password_reset/<str:token>/', views_user.reset_password, name='reset_password'),
