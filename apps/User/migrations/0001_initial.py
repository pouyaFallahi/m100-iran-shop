    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_nuber', models.CharField(blank=True, max_length=11, null=True, verbose_name='phone number')),
                ('is_supervisor', models.BooleanField(default=False, verbose_name='supervisor')),
                ('is_observer', models.BooleanField(default=False, verbose_name='observer')),
